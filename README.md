...
Trong tương lai, ứng dụng sẽ tích hợpt hêm mô hình ORC để nhận diện văn bản, hình ảnh để giúp chúng ta tóm tắt văn bản: người, cấp ra quyết định, nội dung công việc, mức độ bảo mật, ....